...
<h1 class="text-white bg-dark " align="center"> Registar Nueva Refacción </h1>
    ...
    <main> 
        <h2 class="text-info">Registro de nueva refacción</h2>

        <form method="POST" name="fvalida" enctype="multipart/form-data" action="procesador_refaccion.php" class="needs-validation" novalidate>
                    ...
                    <p class="text-danger"> Todos los campos son obligatorios </p>
                                ...
                                <div class="form-group">
                                    <label for="inventario">Inventario:</label> </td>
                                    <select class="custom-select" name="inventario" id="inventario" required>
                                                <option value="">--Seleccione producto de inventario--</option>
                                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="archivo" id="archivo" size="25" maxlength="70" required> 
