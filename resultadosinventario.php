...
<html lang="en">
	...
	<h1 class="text-info"><p align="center"> Resultados de inventario </p> </h1>
    ...
    <?php
			include 'conex.php';
			$enlace = Conectarse();
			$consulta = mysqli_query($enlace, "SELECT r.rfn_id, r.nombre, i.costo, r.descripcion, i.stock FROM t_inventario i INNER JOIN t_refaccion r ON (i.ivo_id = r.inventario_ivo_id);");
		?>
