...
<h1 class="text-white bg-dark " align="center"> Registar Nuevo Auto </h1>
    ...
    <main> 
        <h2 class="text-info">Registro de nuevo auto</h2>

        <form method="POST" name="fvalida" action="procesador_carro.php" class="needs-validation" novalidate>
                    ...
                    <p class="text-danger"> Todos los campos son obligatorios </p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="matricula" id="matricula" placeholder="matricula" class="form-control" required> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="anio" id="anio" placeholder="año" class="form-control" required> 
                                        <div class="invalid-feedback">Complete el campo</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="cliente" id="cliente" require>
