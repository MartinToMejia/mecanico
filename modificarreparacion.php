...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    ...
    <title>Modificar datos de reparacion</title>


</head>
<body class="p-3 mb-2 bg-secondary text-white">

    <h1 class="text-info">Seleccione el campo que desea modificar </h1>
    ...
    ?>
    <form name="formulario" action="modificarre.php" method="POST">
    <label for="descripcion">Modificar: (*): <br></label> <br>
    <select class="form-control form-control-sm" name="descripcion" id="descripcion">
            <?php
            $result=mysqli_query($link,"SELECT descripcion FROM t_reparacion");
