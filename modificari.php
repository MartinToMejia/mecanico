...
<body class="p-3 mb-2 bg-secondary text-white">
    ...
    <?php
        ...
        $costo_busqueda = $_POST["costo"];  

        $resultado=mysqli_query($link,"SELECT * FROM t_inventario WHERE costo = '$costo_busqueda'");

        $resultado_row = mysqli_fetch_array($resultado);

        $id = $resultado_row['ivo_id'];
        $costo = $resultado_row['costo'];
        $stock = $resultado_row['stock'];
    ...
    <main> 
        <h2>Cambia los campos que deseas del inventario</h2>

        <form method="POST" name="fvalida" action="modinventario.php" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="number" step="any" name="costo" id="costo" placeholder="costo" class="form-control" value="<?php echo $costo; ?>" min="100" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="stock" name="stock" placeholder="stock" value="<?php echo $stock; ?>" min="1" required>
                    <div class="invalid-feedback">Complete el campo</div>
                </div>
            </div>
