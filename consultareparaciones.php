<?php 
	...
	$condicion = utf8_decode('Mecánico');
	$consulta = "SELECT e.nombre, e.num_tel, a.matricula, a.marca, a.modelo, r.descripcion, (r.mano_obra + r.total) AS total FROM t_empleado e INNER JOIN t_reparacion r ON (e.epo_id = r.empleado_epo_id) INNER JOIN t_auto a ON(a.ato_id = r.auto_ato_id) ORDER BY a.fecha_registro DESC;";	
...
if(isset($_POST['create_pdf'])){
	...
	$content .= '
		<div class="row">
        	<div class="col-md-12">
            	<h1 style="text-align:center;">Reporte de Reparaciones</h1>
